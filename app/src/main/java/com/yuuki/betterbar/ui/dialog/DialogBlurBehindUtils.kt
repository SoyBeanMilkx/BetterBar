...
open class DialogBlurBehindUtils {
    companion object {
        ...
        private fun getSystemProperty(key: String?): Boolean {
            ...
            try {
                ...
                Log.e("yuuki", "[DialogBlurBehindUtils] Failed to getSystemProperty: ", e)
            }
            return value
        }
                    ...
                    try {
                        ...
                        animator.addUpdateListener { animation: ValueAnimator ->
                            try {
                                ...
                                Log.e(
                                    "yuuki",
                                    "[DialogBlurBehindUtils] Blur behind dialog builder: " + t.toString()
                                )
                            }
                        }
                    } catch (t: Throwable) {
